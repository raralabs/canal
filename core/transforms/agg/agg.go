...
type Aggregator struct {
	...
	after func(message.Msg, pipeline.IProcessorForExecutor, *message.OrderedContent) // This function is called after execute on each message is called
}
...
func (ag *Aggregator) aggFunc(m message.Msg, s *struct{}) (*message.OrderedContent, error) {
