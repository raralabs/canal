...
//
//	if c.num == MaxUint64 {
//		log.Fatalln("Maximum possible number of elements have been passed")
//		return currentValue
//	} else if c.num == 0 {
...
//		lastV := c.lastV
//		content := *msg
//		xk, _ := utils.TryFloat(content[c.field].Value())
//
//		c.num += 1
...
//	c.num += 1
//	content := *msg
//	c.lastMean, _ = utils.TryFloat(content[c.field].Value())
